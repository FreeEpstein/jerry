//Notes:
//assigng a name to a number 
//Assigns a name to a number
//Example very below
typedef enum Buttons {
	...
	Button_Dpad_Left = 174, //This , was deleted (NO NEED TO DELETE ANYTHING HERE IT WORKS!)
	Button_R1 = 44,
	Button_R2 = 11, //this was deleted
	Button_L1 = 37,	
    Button_L2 = 10, //this was deleted
	Button_L3_Push = 36 //new
	// Button_Tpad = 0,
	// Button_Tpad_X = 13,
	// Button_Tpad_Y = 12,
	// Button_X = 18,
...
/* //test below: WRONG SHI 
typedef enum Color_Test {
	//Color Test
   bannerRectRed = 255, 
   bannerRectBlue = 255,
};
...
if (super_man)
	{
		if (!IS_ENTITY_IN_AIR(Me))
		{
			if (Color_Test(255, bannerRectRed) 
			{
