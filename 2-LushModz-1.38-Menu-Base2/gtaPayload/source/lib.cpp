...
u64 (*syscall)(int num, ...) = (void*)0x3329A24;// 1.38
...
void resolveLibs() {
	...
	resolve(libcHandle, strspn);
	resolve(libcHandle, strpbrk);
	resolve(libcHandle, strtok);
	resolve(libcHandle, atoi);
	resolve(libcHandle, isspace);
	resolve(libcHandle, isupper);
	resolve(libcHandle, islower);
	resolve(libcHandle, toupper);
